    ...
    return _then(_value.copyWith(
      ...
      address: null == address
          ...
          : address // ignore: cast_nullable_to_non_nullable
              as String,
      profile_pic_url: null == profile_pic_url
...
class _$UserImpl with DiagnosticableTreeMixin implements _User {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'User(id: $id, first_name: $first_name, last_name: $last_name, email: $email, phone_number: $phone_number, address: $address, profile_pic_url: $profile_pic_url)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('profile_pic_url', profile_pic_url));
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.profile_pic_url, profile_pic_url) ||
                other.profile_pic_url == profile_pic_url));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, first_name, last_name, email,
      phone_number, address, profile_pic_url);
...
abstract class _User implements User {
  factory _User(
      ...
      required final String profile_pic_url}) = _$UserImpl;
